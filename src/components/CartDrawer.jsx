...
export default function CartDrawer({ 
  ...
  const handleSubmitPayment = () => {
    if (!pickupLocation || !paymentProofPreview) return;
  ...
  const isFormValid = pickupLocation && paymentProofPreview;
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-4 space-y-5">
                    ...
                    <div className="bg-surface-container-low border border-outline-variant/30 rounded-xl p-4 text-sm space-y-2">
                      ...
                      <div className="bg-surface-container-lowest p-3 rounded-lg border border-outline-variant/20 space-y-1.5 font-mono text-[11px] text-on-surface-variant">
                        <div className="flex justify-between"><span>Banco:</span> <span className="font-bold text-on-surface">Banco Azote</span></div>
                        <div className="flex justify-between"><span>Cuenta corriente:</span> <span className="font-bold text-on-surface">9876-5432-1012-3456</span></div>
                        <div className="flex justify-between"><span>Cuenta Interbancaria:</span> <span className="font-bold text-on-surface">012345678901234567</span></div>
                  ...
                  <div className="border-t border-outline-variant/30 px-6 py-5 bg-surface-container-low flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <button
                        ...
                        className={`col-span-2 py-3.5 rounded-xl font-headline-md text-xs font-bold flex items-center justify-center gap-2 transition-all duration-200 ${
                          isFormValid 
