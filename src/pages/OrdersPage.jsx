        ...
        <div className="space-y-6">
          {[1, 2].map((i) => (
            <div key={i} className="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-6 animate-pulse">
              <div className="flex flex-wrap justify-between items-center gap-4 pb-4 border-b border-outline-variant/20 mb-4">
                <div className="space-y-2">
                  <div className="h-5 bg-surface-container-high rounded w-32"></div>
                  <div className="h-3 bg-surface-container-low rounded w-48"></div>
                </div>
